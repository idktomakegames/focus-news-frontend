...
export default function Sanatate() {
    ...
    useEffect(() => {
      ...
      const res = await fetch(`https://focus-news-backend-production.up.railway.app/get-articles/category/sanatate/${currentPage}`)
    ...
    return (
      <>
      <Navbar/>
      <h1 className='text-center text-4xl md:text-5xl font-semibold py-10'>Categorie: Sănătate</h1>
            ...
            {articles?.length > 0 && (
                ...
                <fieldset className="flex flex-col items-center border-2 border-blue-600 rounded-lg">
                      <div className='relative w-full'>
                        <img src={articles[0].imageUrl} alt="articleImage" className='w-full h-[500px] object-cover' />
