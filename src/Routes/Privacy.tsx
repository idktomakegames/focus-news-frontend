...
export default function Privacy() {
  return (
    <>
    <Navbar/>
    <h1 className='text-center text-5xl font-semibold py-10'>Politica de Confidențialitate</h1>
    <div className='flex justify-center'>
        <div className='flex flex-col justify-center bg-gray-100 px-5 rounded-lg p-auto w-1/3 md:py-16' id='aboutContainer'>
            ...
            <h2 className="text-xl">Informațiile pe care le colectăm</h2>
            ...
            <h2 className="text-xl">Cum utilizăm informațiile dumneavoastră</h2>
            <p className="mb-4 text-lg">
            ...
            <h2 className="text-xl">Protecția datelor dumneavoastră</h2>
            <p className="mb-4 text-lg">
            ...
            <h2 className="text-xl">Păstrarea datelor</h2>
            <p className="mb-4 text-lg">
            ...
            <h2 className="text-xl">Transferul datelor</h2>
            <p className="mb-4 text-lg">
            ...
            <h2 className="text-xl">Modificări ale Politicii de Confidențialitate</h2>
            <p className="mb-4 text-lg">
            ...
            <h2 className="text-xl">Contactați-ne</h2>
            <p className="mb-4 text-lg">
