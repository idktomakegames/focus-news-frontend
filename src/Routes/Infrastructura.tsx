...
export default function Infrastructura() {
    ...
    useEffect(() => {
      ...
      const res = await fetch(`https://focus-news-backend-production.up.railway.app/get-articles/category/infrastructura/${currentPage}`)
    ...
    return (
      <>
      <Navbar/>
      <h1 className='text-center text-4xl md:text-5xl font-semibold py-10'>Categorie: Infrastructură</h1>
