    ...
    <>
      ...
      <div className='flex justify-center mt-20' id='articleDiv'>
        <div className='flex flex-col items-center w-1/3 gap-8' id='innerArticleDiv'>
          ...
          {isEditing ? 
          <>
            <input type="text" className='bg-gray-100 border overflow-x-auto border-gray-500 py-2 px-1 rounded-lg w-full' placeholder='title' defaultValue={currentArticle?.title} />
